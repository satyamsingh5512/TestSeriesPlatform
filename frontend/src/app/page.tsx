            ...
            <div>
              <div className="inline-flex items-center gap-2.5 bg-white border border-slate-200 px-4 py-2 rounded-full text-[10px] font-black mb-8 uppercase tracking-[0.15em] shadow-sm group cursor-default">
                <div className="relative flex items-center justify-center">
                  <Sparkles className="w-4 h-4 text-blue-600 relative z-10 animate-[pulse_2s_ease-in-out_infinite]" />
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="relative bg-white border border-slate-200 p-10 rounded-[48px] shadow-[0_48px_96px_-32px_rgba(0,0,0,0.12)]">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button onClick={() => openModal('login')} className="p-5 border border-slate-100 rounded-3xl hover:border-blue-200 hover:bg-blue-50/50 transition-all text-left group active:scale-95">
        ...
        <section className="py-20 max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <button key={t} onClick={() => openModal('login')} className="group bg-white p-8 rounded-[32px] border border-slate-100 hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-500/5 transition-all flex flex-col items-center text-center w-full active:scale-95">
                <div className={`w-24 h-24 rounded-3xl border border-slate-50 flex items-center justify-center mb-6 ${e.color} group-hover:scale-110 transition-transform overflow-hidden p-4 bg-white`}>
                  <img src={e.logo} alt={e.title} className="w-full h-full object-contain mix-blend-multiply" loading="lazy" />
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
            <div>
              ...
              <ul className="space-y-6 mb-12">
                {["75,000+ Mock Tests & Sectionals", "17,000+ Previous Year Papers", "Predictive All India Rank (AIR)", "Deep Performance & Time Analysis"].map((text, i) => (
              ...
              <button onClick={() => openModal('login')} className="bg-white hover:bg-slate-100 text-slate-900 font-black text-xl px-12 py-5 rounded-[24px] shadow-2xl transition-all active:scale-95">
                Get Pass Pro @ ₹399
              </button>
            </div>
